...
if (NOT CPPCHECK_EXECUTABLE MATCHES "NOTFOUND")
    ...
    add_custom_target(CocktailProCppCheck
            ${CPPCHECK_EXECUTABLE} --suppress=missingIncludeSystem --xml --xml-version=2 --enable=all --suppress=missingOverride --language=c++ --std=c++11 --quiet ${COCKTAIL_PRO_SOURCES}
